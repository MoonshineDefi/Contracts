...
// File contracts/xxx/MoonshineToken.sol
...
contract MoonshineToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    constructor(address trustedForwarder) ERC20("Moonshine Token", "XXX") ERC20Permit("Moonshine Token") {
